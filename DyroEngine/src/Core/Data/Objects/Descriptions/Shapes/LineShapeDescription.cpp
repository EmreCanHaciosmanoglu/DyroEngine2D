...
LineShapeDescription::LineShapeDescription(const LineShapeDescription& ref)
	...
	,v2(ref.v2)
{}
LineShapeDescription::LineShapeDescription(float x1, float y1, float x2, float y2, float lineWidth)
	:ShapeDescription(Color(),lineWidth)
	,v1(x1,y1)
	,v2(x2,y2)
{}
LineShapeDescription::LineShapeDescription(const Vector2D& v1, const Vector2D& v2, float lineWidth)
	:ShapeDescription(Color(),lineWidth)
	,v1(v1)
	,v2(v2)
{}
